...
package peasycam.src.peasy.org.apache.commons.math.geometry;
...
public class Rotation implements Serializable {
     ...
     * @param threshold convergence threshold for the iterative orthogonality
     *                  correction (convergence is reached when the difference between
     *                  two steps of the Frobenius norm of the correction is below
     *                  this threshold)
     * @throws NotARotationMatrixException if the matrix is not a 3X3 matrix, or if it cannot be
     ...
     * @throws CardanEulerSingularityException if the rotation is singular with respect to the angles set
     *                                         specified
     */
     ...
     * @throws NotARotationMatrixException if the matrix cannot be orthogonalized with the given
